...
import { ILandscapeLayerOptions, DeafultLayerOptions } from './landscapeLayer';
...
export const layersOptions: ILandscapeLayerOptions[] = [
	{
		...
		gap: DeafultLayerOptions.gap,
		strokeColor: DeafultLayerOptions.strokeColor,
		strokeWidth: DeafultLayerOptions.strokeWidth,
		pointRadius: DeafultLayerOptions.pointRadius,
		pointColor: DeafultLayerOptions.pointColor,
		activePointColor: DeafultLayerOptions.activePointColor,
		hoveredPointColor: DeafultLayerOptions.hoveredPointColor,
	},
	{
		roughness: 0.7,
		points: [
